...
for i in range(1, 3):
    ...
    f = cdms.open(
        all_dirs[0] + 'n.n202.N1850frc2.f09_tn14.pi_control.004_BASE.cam.h0.1709_FISCCP1.nc', 'r')
    ...
    f = cdms.open(
        all_dirs[0] + 'n.n202.N1850frc2.f09_tn14.pi_control.004_BASE.cam.h0_TREFHT.nc', 'r')
    tas1 = f('TREFHT')
    f.close()
    f = cdms.open(
    ...
    for sec in sections:
        ...
        save_dir = '/projects/NS9252K/noresm/cases/WP4_shofer/n.n202.NSSP585frc2.f09_tn14.ssp585.004_BASE_end/atm/hist/COSP/cloud_feedbacks/'
